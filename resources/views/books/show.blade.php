...
<div class="container">
    ...
    @if($book->isBorrowed())
        <div class="alert alert-warning">
            Este livro já está emprestado no momento. Aguarde a devolução para registrar um novo empréstimo.
        </div>
    @endif
        ...
        <div class="card-body">
            <form action="{{ route('books.borrow', $book) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="user_id" name="user_id" required {{ $book->isBorrowed() ? 'disabled' : '' }}>
                ...
                <button type="submit" class="btn btn-success" {{ $book->isBorrowed() ? 'disabled' : '' }}>
